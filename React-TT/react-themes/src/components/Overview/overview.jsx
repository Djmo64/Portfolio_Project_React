  ...
  return (
    <div className="overview-container load">
      <div className="bio">
        ...
        <p>
          I am an adaptable software engineering major currently attending
          Kennesaw State University. Aiming to leverage proven critical
          thinking, problem solving, and communication skills, as well as
          software development experience to successfully fill the software
          engineering role at your company. Frequently praised as hard working
          by my peers, supportive teamwork, as well as dependable initiative, I
          can be relied upon to help your company achieve it's goals
        </p>
        <div className="stats">
          <div style={{ width: "45%" }}>
            <h1>Interests: </h1>
            <p>
              ...
              My favorite author is Michael Whitehouse.
            </p>
            <p>
              <b>Exercising</b> - I enjoy weight lifting and running. My PB in
              bench is 305lb.
            </p>
            <p>
